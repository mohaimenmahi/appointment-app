...
class AppointmentApp extends Component {
  ...
  handleDBResponse(response) {
    ...
    const schedule = !appointments.length
      ...
      : appointments.reduce((currentSchedule, appointment) => {
        ...
        const dateString = moment(slot_date).format("YYYY-DD-MM");
      ...
      for(let day in schedule) {
        ...
        slots.length
          ? slots.every(slot => slot === true) ? (schedule[day] = true)
          : null
          : null;
      }
    ...
    return (
      <section>
        ...
        <p>
          Appointment: {" "}
          <span style={spanStyle}>
            {moment(this.appointmentDate).format("dddd[,] MMMM Do[,] YYYY")}
          </span>{" "}
          at{" "}
          <span style={spanStyle}>
            {
  ...
  handleSubmit() {
    ...
    axios
      ...
      .then(response =>
        this.setState({
          confirmationSnackbarMessage: "Appointment Successfully saved",
    ...
    const datePickerExample = () => (
      <div>
        <DatePicker
          ...
          mode={smallScreen ? "potrait" : "landscape"}
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            ...
            <Step disabled={!data.appointmentDate}>
              <StepLabel>
                Choose an available time for your appointmnet
              </StepLabel>
              <StepContent>
                <SelectField
                ...
                <p>
                  <section>
                    ...
                    <TextField
                      ...
                      errorText={
                        this.validPhone ? null : "Enter a valid phone number"
                      }
                      onChange={(evt, newVal) =>
                    ...
                    <RaisedButton
                      ...
                      label={
                        contactFormFilled ? "Schedule" : "Fill out your information to the schedule"
                      }
        ...
        <SnackBar
          ...
          message={
            isLoading ?
            "Loading..." : data.confirmationSnackbarMessage || ""
          }
